...
class Tag(AbstractModel):
    ...
    # articles = models.ManyToManyField('webapp.Article', related_name='tags', through='webapp.ArticleTag',
    #                                   through_fields=('tag', 'article'), blank=True)
...
class ArticleTag(AbstractModel):
